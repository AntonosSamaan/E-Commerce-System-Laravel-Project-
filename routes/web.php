...
Route::middleware([
  ...
  Route::middleware('auth', 'change_lang')->group(function(){
    Route::controller(UserProductController::class)->group(function () {
        Route::get('all-products', 'index')->name('user.products.index');
        ...
        Route::delete('cart/{id}','delete')->name('user.cart.delete');
    });
    ...
    Route::controller(OrderController::class)->group(function(){
        ...
        Route::get('makeOrder', 'makeOrder')->name('user.makeOrder');
    });
});
